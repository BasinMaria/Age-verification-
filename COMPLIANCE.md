...
| 🇺🇸 **Калифорния** | ⚠️ **Да** + | Максимальные настройки приватности по умолчанию | CAADCA (AB 2273) | [Legislature](https://leginfo.legislature.ca.gov/faces/billNavClient.xhtml?bill_id=202120220AB2273) | DOB для проверки OK, но данные для age estimation нельзя использовать для другого |
...
| | |
|---|---|
| **Что делать** | DOB + **высокие настройки приватности по умолчанию** для всех пользователей. Данные для age estimation нельзя использовать ни для чего другого. |
| **Почему** | CAADCA (AB 2273) — требует «оценивать возраст с разумной уверенностью». В марте 2026 Девятый округ подтвердил: требования по age estimation и высоким настройкам приватности — действуют. |
