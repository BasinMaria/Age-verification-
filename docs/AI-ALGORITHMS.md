...
### Хронологическая лента (альтернатива)

| Аспект | Описание |
|---|---|
| **Что это** | Все посты в обратном хронологическом порядке (новые сверху) |
...
| **По умолчанию** | Алгоритмическая лента (по умолчанию) — пользователь может переключить на хронологическую |
